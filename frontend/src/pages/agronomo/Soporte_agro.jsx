      ...
      <div className="overflow-x-auto bg-white shadow-md rounded-lg relative">
        <table className="min-w-full text-base text-center table-fixed">
          <thead className="bg-green-600 text-white">
            <tr>
              <th className="px-4 py-4 border w-32">
              ...
              <th className="px-4 py-4 border w-64">
                <div className="flex items-center justify-center gap-2">
                  <span>Asunto</span>
                  <button
              ...
              <th className="px-4 py-4 border w-40">
                <div className="flex items-center justify-center gap-2">
                  <span>Estado</span>
                  <button
              ...
              <th className="px-4 py-4 border w-48">
                <div className="flex items-center justify-center gap-2">
              ...
              datosFiltrados.map((t) => (
                <tr key={t.id} className="border-t hover:bg-gray-50">
                  ...
                  <td className="p-3 border w-32">
                    <button
                      onClick={() =>
                        navigate("/detallesticketa", { state: { ticket: t } })
                      }

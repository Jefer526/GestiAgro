...
const Detalles_agrop = () => {
  ...
  // Estado y refs para tarjeta flotante perfil
  const nombreUsuario = "Juan Pérez"; // Cambiar por nombre real del usuario
  ...
  // Cierra tarjeta perfil al hacer click fuera
  useEffect(() => {

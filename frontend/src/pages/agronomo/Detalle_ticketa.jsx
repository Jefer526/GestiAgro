...
const Detalles_ticketa = () => {
  ...
  // Si recibimos ticket por navigate, lo usamos, si no lo pedimos al backend
  useEffect(() => {
    if (state?.ticket) {
      setTicket(state.ticket);
    } else {
      // en caso de recargar la página sin state
      // podrías leer el id desde params y hacer soporteApi.getTicket(id)
    }
  }, [state]);

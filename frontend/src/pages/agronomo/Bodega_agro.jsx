    ...
    <div className="flex">
      ...
      <div className="flex-1 p-10 overflow-auto">
              ...
              {datosFiltrados.map((d, i) => (
                <tr key={i} className="border-b border-gray-200">
                  ...
                  <td className="px-4 py-2 border text-center">
                    <button onClick={() => navigate("/Detallesagrop")} className="bg-blue-100 text-blue-800 px-4 py-1 rounded-full text-sm font-medium flex items-center gap-1 justify-center mx-auto">
        ...
        <div className="flex justify-center gap-20 mt-10">
          <button onClick={() => navigate("/agregarproducto")} className="bg-green-600 text-white px-8 py-2 rounded-md hover:bg-green-700 text-lg font-semibold">
            Agregar producto
          </button>

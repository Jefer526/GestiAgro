...
const Editar_finca = () => {
  ...
  // Para la inicial de perfil
  const nombreUsuario = "Juan Pérez"; // Cambiar dinámicamente si quieres
  const letraInicial = (nombreUsuario?.trim()?.[0] || "U").toUpperCase();

  // Estado y ref para mostrar/ocultar tarjeta perfil
  const [mostrarTarjeta, setMostrarTarjeta] = useState(false);
  const tarjetaRef = useRef(null);

  // Cierra la tarjeta perfil si haces clic fuera
  useEffect(() => {

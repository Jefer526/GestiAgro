...
const Editar_finca = () => {
  ...
  const [finca, setFinca] = useState({ nombre: "", ubicacion: "", coordenadas: "", area: "" });

  // Inicial del usuario para el perfil
  const nombreUsuario = "Juan Pérez";
  const letraInicial = (nombreUsuario?.trim()?.[0] || "U").toUpperCase();

  // Estado y referencia para tarjeta de perfil
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 p-10 overflow-y-auto relative">
        ...
        {/* Botón volver */}
        <button onClick={() => navigate("/crearfinca")} className="flex items-center text-green-600 font-semibold mb-6 text-lg hover:underline">

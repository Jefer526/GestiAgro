...
const Detalle_laborm = () => {
  ...
  return (
    <LayoutMayordomo>
      {/* Botón volver */}
      <button
        onClick={() => navigate("/seguimiento_laboresm")}
        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="w-full bg-gray-200 h-5 rounded overflow-hidden">
            <div
              ...
              style={{ width: `${datosCabecera.avance}%` }}
            />
          </div>
          <p className="text-right text-base font-semibold mt-1">
            {datosCabecera.avance}%
          </p>
        </div>
      </div>

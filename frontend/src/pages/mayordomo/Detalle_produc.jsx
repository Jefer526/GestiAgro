import {
  ...
  const Detalle_produc = () => {
    ...
    const datosFiltrados = movimientos.filter((d) => {
      const fechasSeleccionadas = valoresSeleccionados["fecha"];
      return !fechasSeleccionadas || fechasSeleccionadas.includes(d.fecha);
    });
                ...
                <tr>
                  <th className="px-4 py-3 border-r border-gray-300">
                    <div className="flex justify-between items-center">
                      FECHA
                      <button onClick={(e) => toggleFiltro("fecha", e)}>

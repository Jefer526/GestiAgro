    ...
    <aside className="fixed left-0 top-0 w-28 h-[100dvh] bg-green-600 flex flex-col justify-between z-[200]">
      ...
      >
        {[
          ...
          { icon: <IconBook />, route: ["/cuadernocampom", "/registro_campom", "/detalle_registrocampom", "/detallecampom",] },
          { icon: <IconPlant2 />, route: ["/Produccion_mayor", "/registrar_produccionm"] },
          { icon: <IconChartBar />, route: "/informes_mayordomo" },
          { icon: <IconCalendarClock />, route: "/programacion_labores" },
          { icon: <IconBug />, route: ["/manejo_fitosanitariom", "/registrarmonitoreom"] },
          { icon: <IconBox />, route: ["/Bodega_insumos", "/detalle_producto", "/registrarmovimientom"] },

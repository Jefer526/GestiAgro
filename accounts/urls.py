...
# Definición de rutas para la aplicación Accounts
urlpatterns = [
    ...
    path("users/<int:pk>/toggle-active/", AccountsUserToggleActiveAPIView.as_view(), name="accounts-users-toggle-active"),
